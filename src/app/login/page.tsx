        ...
        <div className="border border-border rounded-lg bg-bg-card p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-lg font-bold tracking-tight">
              Sign in to Tool<span className="text-accent">Route</span>
            </h1>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-medium text-sm rounded-lg px-4 py-3 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
